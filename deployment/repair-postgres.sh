#!/bin/sh
# Quick repair when PostgreSQL server was removed by pkg conflicts on FreeBSD 15
...
info "PostgreSQL repaired. Now run:"
echo "  cd /opt/karyaradhane && git pull origin main && sh deployment/freebsd-setup.sh"
